...
<script src="view/javascript/jquery.colorpicker.js"></script>
<script src="view/javascript/jquery.ui.colorpicker-pantone.js"></script>
<script src="view/javascript/jquery.ui.colorpicker-rgbslider.js"></script>
<script src="view/javascript/jquery.ui.colorpicker-memory.js"></script>
<script src="view/javascript/jquery.ui.colorpicker-cmyk-parser.js"></script>
<script src="view/javascript/jquery.ui.colorpicker-cmyk-percentage-parser.js"></script>
<link href="view/stylesheet/jquery.colorpicker.css" rel="stylesheet" type="text/css"/>
...
<div id="header">
  <div class="div1">
    <div class="div2"><img style="display:none" src="view/image/logo.jpg" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" style="width: 130px;" /></div>
    <?php if ($logged) { ?>
