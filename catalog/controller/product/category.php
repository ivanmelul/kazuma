...
class ControllerProductCategory extends Controller {
    ...
    public function index() {
        ...
        //Banner slider
        $this->data['banners_slider'] = array();
        
        //16 es el banner de colección
        ...
        //22 es el banner de inicio de catalogo
        ...
        if ($category_info) {
            ...
            $this->data['text_view_detail'] = $this->language->get('text_view_detail');

            $this->data['button_cart'] = $this->language->get('button_cart');
            $this->data['button_wishlist'] = $this->language->get('button_wishlist');
            $this->data['button_compare'] = $this->language->get('button_compare');
            $this->data['button_continue'] = $this->language->get('button_continue');
			if((empty($_GET["path"])) or ($_GET["path"] != '103')){
				if($category_id == SALE_CATEGORY_ID){
					$this->data['category_image'] = 'image/sale.jpg';
				}else{
					$this->data['category_image'] = 'image/banner-category.jpg';
				}
			}else{				
				if($category_id == SALE_CATEGORY_ID){
					$this->data['category_image'] = 'image/sale.jpg';
				}else{
					$this->data['category_image'] = 'image/banner-category-sale.jpg';
				}			
			}
            ...
            $this->data['grid_class'] = count($results) <= 3 ? 'product-grid-left' : '';
            $url = '';
